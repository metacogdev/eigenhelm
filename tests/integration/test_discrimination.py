...
class TestRunDiscriminationTest:
    ...
    def test_report_structure(
        self, fixture_model: EigenspaceModel, tmp_path: Path
    ) -> None:
    ...
    def test_empty_dirs_produce_nan(
        self, fixture_model: EigenspaceModel, tmp_path: Path
    ) -> None:
...
class TestSummaryAndRendering:
    ...
    def test_summary_aggregation(self) -> None:
        reports = [
            ...
            DiscriminationReport(
                "javascript", "A", 4, 0.91, 1.3, 1.8, 0.25, 0.60, 0.71, True
            ),
            DiscriminationReport(
                "typescript", "A", 4, 0.90, 1.2, 1.7, 0.28, 0.58, 0.65, True
            ),
            DiscriminationReport("go", "A", 3, 0.89, 1.1, 1.5, 0.30, 0.55, 0.60, True),
            DiscriminationReport(
                "rust", "A", 4, 0.91, 1.4, 1.9, 0.22, 0.57, 0.73, True
            ),
        ]
